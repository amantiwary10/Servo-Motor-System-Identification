...
var t = 120;                // Time of the ramp input (seconds)
var plateauDuration = 30;   // Time to wait at each plateau (seconds)
...
function rampUp(){
    ...
    rcb.output.ramp("servo3", minVal, maxVal, t, upPlateau);
}
...
function rampDown() {
    if(rampGoDown){
        ...
        rcb.output.ramp("servo3", maxVal, minVal, t, endPlateau);
    }else
        endScript();
}
