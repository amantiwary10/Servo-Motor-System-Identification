function [pwm_ramp_2, motor_rpm_ramp_2, time_ramp_2, current_ramp, di_dt] = data_mapping_Ramp()
%% Data Pre-Processing

% Collecting RPM readings taken by the app
[RPM_ramp, time_ramp, ~] = readvars('RPM_data.csv');

% Collecting the readings taken by the board
Time_2_ramp = readvars('RampTest_1.csv', 'Range', 'A9:A19138');
pwm_ramp = readvars('RampTest_1.csv', 'Range', 'E9:E19138');
current_ramp = readvars('RampTest_1.csv', 'Range', 'L9:L19138');
di_dt = rate_of_change(current_ramp, Time_2_ramp);
...
pwm_ramp_2 = pwm_ramp;        % caculating duty cycle
