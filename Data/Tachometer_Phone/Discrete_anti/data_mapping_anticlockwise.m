function [pwm_anti, motor_rpm_anti, time_anti] = data_mapping_anticlockwise()
...
pwm_anti = pwm_step_anti(1+51:51+51);
motor_rpm_anti = motor_rpm_step_anti(1+51:51+51);
time_anti = Time_2_step_anti(1+51:51+51);
